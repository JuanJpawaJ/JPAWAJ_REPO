...
(codcli_ctecli,nrodocu_ctecli,fecha_ctecli,desc_ctecli,tmov_ctecli,mone_ctecli,total_ctecli,esta_ctecli,fpago_ctecli,obs_ctecli,codven_ctecli,saldo_ctecli) VALUES ('$codcli_provi','$nrodocu_provi','$fecmov_provi','$descriventa','I','S','$sumtot_ped','$estado_ctecli','$fecmov_provi','  ','$codven_provi','$sumtot_ped')";
$resultctecli=mysqli_query($connec,$sqlctecli);	
}
