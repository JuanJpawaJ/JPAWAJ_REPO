...
while ($tabla=mysqli_fetch_array($result)) {
      ...
      <tr bgcolor="#FFFFFF" class="tabla10">
        ...
        <td align="center" bgcolor="#FFFFFF"><a href="a_ventas1_rapida.php?xcodigo_cli=<?php echo($codigo_cli);?>&xrsocial_cli=<?php echo($rsocial_cli);?>&xtprec_cli=<?php echo($tprec_cli);?>&xestado_cli=<?php echo($estado_cli);?>&xnxixvx=<?php echo($xnxixvx)?>&xvendedor_cli=<?php echo($vendedor_cli)?>">Nva. Venta.</a></td>
       </tr>
      <?php 
	  }
	  }
