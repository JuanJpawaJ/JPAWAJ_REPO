...
?>
  ...
  <tr class="tit_menu_sup">
    <td width="679" align="center" bgcolor="#FFFFCC"><table width="912" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="183" height="34" align="center"><a href="../principal.html"><img src="../imagenes_idx/bot_pawacorp.png" width="183" height="20"></a></td>
        <td width="140" align="center"><a href="ilbupsil.php"><img src="../imagenes_idx/bot_listaprecios.png" width="140" height="20"></a></td>
  ...
  <tr class="tit_menu_sup">
    ...
    <table width="987" height="80" border="1" cellspacing="0">
      <tr bgcolor="#CCFFFF" class="diez">
        ...
        <td width="244" align="center">PRODUCTO</td>
...
?>
      ...
      <tr bgcolor="#FFFFFF" class="tabla10">
        ...
        <td bgcolor="#FFFFFF"><a href="ilbupweiv.php?idx=<?php  echo($id); ?>"><img src=" <?php echo "img_items/".$img_it ?> " width="60" height="%" /><? if ($pv03_it>0) {?> <img src="iconos/promocion.jpg" alt="EN OFERTA" width="14" height="30" /> <? } ?></a></td>
   ...
   <td align="right" bgcolor=<? echo($color1) ?> ><?php echo($simbolo_mone.money_format('%n',($pv01_it))) ?></td>
        ...
        <td><a href="n_admin_3view.php?idx=<?php  echo($id); ?>&xview=<?php  echo("ADMIN"); ?>&xareg=NNOOO&xmodi=NOOOOO&xdelreg=NOOOOO">mod</a></td>
        <td bgcolor="#FFCC66" align="center"><a href="img_items/n_subir_xfile.php?id_img=<?php  echo($id); ?>">Img</a></td>
...
?>
    ...
    <tr>
      <td height="26" colspan="2" bgcolor="#FDF19B" class="TITULO">Producto: (Tx. para factura) Ej. MOUSE GAMER A.. <br>  (60 caracteres)</td>
      </tr>
    <tr>
      <td colspan="2" class="TITULO">
      <input name="xproducto" type="text" id="xproducto" size="35" maxlength="60" onKeyUp="this.value=this.value.toUpperCase();" /></td>
      </tr>
    <tr>
    ...
    <tr>
      <td bgcolor="#FDF19B" class="TITULO">Grupo Lista</td>
      <td><span class="TITULO">
        <input name="xgrupolista" type="text" id="xgrupolista" size="6" maxlength="6" onKeyUp="this.value=this.value.toUpperCase();" />
        </span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td bgcolor="#FDF19B" class="TITULO">Observaciones</td>
      <td><span class="TITULO">
    ...
    <tr>
      <td colspan="2"><table width="306" border="1">
        <tr>
          <td width="120" rowspan="2" bgcolor="#FFFF66" class="tabla10">GRUPO (4 dígitos 1 o 0)<br/>
            Ej. 1000, 1010, 0100</td>
          <td width="170" class="tabla10">Computo, M.Bonita, Regalos, Comida</td>
        </tr>
        <tr>
