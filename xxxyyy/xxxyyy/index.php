...
<head>
   ...
   <!-- <base href="https://www.pawacorp.com/index.html" />-->
    ...
    <meta name="keywords" content="delibears.jpawaj.com:: delibears :: delibears hamburguesas : delibers : deli :: hamburguesas delibears:: delivery delibears :: AQP :: deliber delivery :: Sandwich salchipapas hotdog arequipa Jose Luis Bustamante y Rivero, delibears jlb y rivero, salchipapas hamburguesas en arequipa, yoguis delibears" />
    <meta name="description" content="delibears.jpawaj.com:: Deli bears :: delibears :: hamburguesa delibears :: HAMBURGUESA DELIBEARS :: DELIBERY DELIBEARS AREQUIPA :: AQP :: burguer delibears delivery :: delibears peru :: Delibears Arequipa Perú :: Delicioso hamburguesas delibears delivery" />
    <title>Delibears - Delivery.</title> 
...
<body>
    ...
    <div class="barra_menu">
        <div class="imagen_barra_menu">
            <img src="imagenes/delibears.png" alt="logo" class="logo">
        </div>
        <!-- DIV HORIZONTAL--> 
   ...
   <div style="height:5rem"></div> 
    ...
    <div class="div_circulos">
        ...
        <div class="cir_contenedor">
            <div class="cir_imagen1">
                <img src="imagenes/3_publis_1.jpg" alt="check"> 
            </div>
            <div class="cir_contenedor_texto">
                <p><a href="#xproductos"><img src="imagenes/bot_productos.png" width="250" height="%" style="border:0;" onmouseover="this.style.border='solid  2px  #0a3d89';" onmouseout="this.style.border=0;" border="0"></a></p>
        ...
        <div class="cir_contenedor">
            <div class="cir_imagen1">
                 <img src="imagenes/3_publis_2.jpg" alt="check"> 
            </div>
            <div class="cir_contenedor_texto">
                <p><a href="#xeducacion"><img src="imagenes/bot_educacion.png" width="250" height="%" style="border:0;" onmouseover="this.style.border='solid  2px  #0a3d89';" onmouseout="this.style.border=0;" border="0"></a></p>
            </div>
        </div>

        <div class="cir_contenedor">
            <div class="cir_imagen">
                 <img src="imagenes/3cajera.jpg" alt="check"> 
            </div>
            <div class="cir_contenedor_texto">
                <p><a href="#xstecnico"><img src="imagenes/bot_stecnico.png" width="250" height="%" style="border:0;" onmouseover="this.style.border='solid  2px  #0a3d89';" onmouseout="this.style.border=0;" border="0"></a></p>
