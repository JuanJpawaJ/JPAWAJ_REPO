...
<body>
    ...
    <div class="barra_menu">
        ...
        <div class="enlaces_menu">
            ...
            <span class="TELEFONOS">959956000 - 959956060 -agregando Juan Diego</span>
            <!-- DIV HAMBURGUESA-->
                ...
                <ul>
                    <li><a href="#"><img src="imagenes/3rayas.png" alt="logo" width="%" height="30"></a>
                        <ul>
                            ...
                            <li><a href="#xproductos">Productos</a></li>
                            <li><a href="#xeducacion">Educación</a></li>
                            <li><a href="#xstecnico">S. Técnico Modificado</a></li>
                            <li><a href="#xdelivery">Delivery</a></li>
                            <!--   <li><a href="#xclientes">Clientes</a></li> -->
                            <li><a href="#xcontactos">Contactos</a></li>
                        </ul>
        ...
        <div class="div_productos">
            ...
            <div class="campo_formulario_nuevo">
                ...
                <div class="formulario_stec_nuevo">
                    <div class="parte_formulario">
                        <div class="contenedor_formulario">
                            <h2 class="cabecera_formulario">Deseo obtener una<br> revisión GRATUITA!<br> de mi equipo.
                                Gracias</h2>
                            ...
                            <form class="formulario_oficial" method="post" action="insert_mail.php">
                                ...
                                <div class="campos_formulario">
                                    ...
                                    <input type="text" id="correo" name="correo"
                                        placeholder="ej. Enciende. Pero... se queda en un cursor">
                                </div>
            ...
            <div class="div_texto_stecnico">
                <div class="parte_texto_new">
                    <p>
                        Nuestro departamento de Ingeniería con la experiencia de más de 20 años al servicio de empresas
                        y público en general. Agradeciendo sobre todo la confianza depositada en nuestra empresa es que,
                        ante esta situación de cuarentena, hemos reformulado nuestro SERVICIO DELIVERY el cual, tiene 3
                        fases: Recogemos su equipo, reparamos y devolvemos a domicilio sin costo adicional. Contamos con
                        stock de repuestos de todas las marcas en PCs, Laptops e impresoras.
                    </p>
