   ...
   <div style="height:5rem"></div> 
    ...
    <div class="div_circulos">
        ...
        <div class="cir_contenedor">
            ...
            <div class="cir_contenedor_texto">
                <p><a href="https://www.jpawaj.com/siga_jpawaj/a_lisgeneral.php?xgl=R"><img src="imagenes/bot_regalostore.png" width="250" height="%" style="border:0;" onmouseover="this.style.border='solid  2px  #0a3d89';" onmouseout="this.style.border=0;" border="0"></a></p>

            </div>
        </div>
        <div class="cir_contenedor">
            <div class="cir_imagen">
                 <img src="imagenes/circulo_aroma.png" alt="check"> 
            </div>
            <div class="cir_contenedor_texto">
                <p><a href="https://www.jpawaj.com/siga_jpawaj/a_lisgeneral.php?xgl=P"><img src="imagenes/bot_aromas.png" width="250" height="%" style="border:0;" onmouseover="this.style.border='solid  2px  #0a3d89';" onmouseout="this.style.border=0;" border="0"></a></p>
